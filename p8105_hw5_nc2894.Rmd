...
plot_2
```
Comment: The sample average of mu across tests for which the null is rejected is greater than the true value of mu until the true value of mu reached 4. This makes sense because as the effect size increases, the power of the test increases as well, and when the effect size is around 4, the power of the test also reaches its maximum value of 1. 
